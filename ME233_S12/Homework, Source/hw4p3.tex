...
%\end{align*}
%$x_w(k-1)$ can be determined without being contaminated by measurement noise at the instance $k$.Therfore, if you set the measurement covariance to zero and obtain the equations for the Kalman filter, you will obtain $\hat x_w(k-1 |k)$.
